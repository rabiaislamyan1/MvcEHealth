...
namespace MvcESaglik.Controllers
{
    public class KullaniciPanelController : Controller
    {
        ...
        {
            var tc = (string)Session["TcNo"];
            var degerler = c.KullaniciProfils.FirstOrDefault(x => x.TcNo == tc);
            ViewBag.m = tc;
            return View(degerler);
        }

        public ActionResult RandevuGecmis()
        {
            var degerler = c.Randevus.ToList();
            return View(degerler);
        }
        ...
        public ActionResult RandevuOlustur(Randevu k)
        {
            ...
            c.Randevus.Add(k);
            c.SaveChanges();
            return RedirectToAction("RandevuGecmis");
        }
        ...
        {
            var tc = (string)Session["TcNo"];
            var degerler = x.KullaniciProfils.FirstOrDefault(x => x.TcNo == tc);
            ViewBag.m = tc;
            return View(degerler);
        }
